...
class EmailHelper {
  ...
  parsedData(data) {
    ...
    const {
      ...
      headers, categories, opentracking, clicktracking, substitutions, sendAt,
    ...
    this.setOpentracking(opentracking);
  ...
  setDynamicTemplateData(dynamicTemplateData) {
    ...
    this.requestData.dynamic_template_data = {};

    Object.entries(dynamicTemplateData).forEach((val) => {
      this.requestData.dynamic_template_data[val[0]] = val[1];
    });
  }
  ...
  setOpentracking(opentracking) {
    if (typeof opentracking === 'undefined') {
      return;
    }

    this.requestData.analytics = this.requestData.analytics || {};
    this.requestData.analytics.opentracking = !!opentracking;
  }
  ...
  setSendAt(sendAt) {
    ...
    this.requestData.send_at = sendAt;
  }
